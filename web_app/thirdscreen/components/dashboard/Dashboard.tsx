    ...
    <div className="flex h-dvh flex-col overflow-hidden bg-background">
      ...
      <DashboardContext value={{
        ...
        <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
          <DialogContent className="flex max-h-[calc(100vh-5rem)] flex-col overflow-hidden p-0 top-[calc(50%+1.75rem)] translate-y-[-50%]" style={{ maxWidth: "min(640px, 90vw)", width: "min(640px, 90vw)" }}>
        ...
        <div className="relative z-50 h-9 shrink-0 overflow-visible">
          <StatusBar />
        </div>
      </DashboardContext>
    </div>
    ...
    <div className="mx-auto max-w-2xl px-6 py-8">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <p>If you have questions about this privacy policy, you can reach us at <a href="mailto:eric@thirdscr.com" className="text-primary hover:underline">eric@thirdscr.com</a>.</p>
        </section>
      </div>
    </div>
  )
    ...
    <div className="mx-auto max-w-2xl px-6 py-8">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <p>Questions about these terms can be directed to <a href="mailto:eric@thirdscr.com" className="text-primary hover:underline">eric@thirdscr.com</a>.</p>
        </section>
      </div>
    </div>
  )
