        ...
        <div className="space-y-8 text-neutral-600 text-sm leading-relaxed dark:text-white/70">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              ...
              <li><strong className="text-neutral-900 dark:text-white">Paddle</strong> - We use Paddle as our payment processor (Merchant of Record) for paid subscriptions. Paddle collects and processes your billing information (name, email, payment method, billing address) according to their <a href="https://www.paddle.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-[#3b82f6] hover:underline">privacy policy</a>. We do not directly store your payment card details.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-neutral-900 font-semibold text-lg mb-3 dark:text-white">9. Open Source</h2>
            <p>Third Screen is open source under the MIT license. You can inspect the complete source code at <a href="https://github.com/ericvaish/thirdscreen" target="_blank" rel="noopener noreferrer" className="text-[#3b82f6] hover:underline">github.com/ericvaish/thirdscreen</a> to verify exactly what the application does with your data.</p>
          </section>

          <section>
            <h2 className="text-neutral-900 font-semibold text-lg mb-3 dark:text-white">10. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-neutral-900 font-semibold text-lg mb-3 dark:text-white">11. Contact</h2>
            <p>If you have questions about this privacy policy, you can reach us at <a href="mailto:eric@thirdscr.com" className="text-[#3b82f6] hover:underline">eric@thirdscr.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
